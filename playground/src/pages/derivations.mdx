...
export const PriceSimulator = component({
  ...
  setup: ({ items }) => {
     ...
     * a pure pipe. Each row owns an independent instance.
     */
    return @{
...
<div class="annotation">
  <strong>Key insight:</strong> Derivations cover the same transform use case as pipes, but also support DI — making them strictly more powerful while maintaining the same scoping and lifecycle guarantees.
</div>
